...
# MAGIC %md
# MAGIC # ðŸš€ Hybrid Fixed Severity Classification Agent
# MAGIC
...
def process_batch(batch_df, batch_id):
    try:
        ...
        # âœ… Enforce exact schema (no ingestion_timestamp leakage)
...
# Double check no streams are left running
