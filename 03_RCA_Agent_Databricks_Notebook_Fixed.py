...
"""
        ...
        try:
            ...
            if ai_response["success"]:
                ...
                logger.info("✅ AI-powered RCA analysis completed successfully")
                return {
                    "success": True,
                    "analysis": analysis,
    ...
    def generate_rca(self, rca_input: RCAInput) -> RCAOutput:
        ...
        try:
            ...
            if self.use_foundation_model and self.databricks_token:
                try:
                    logger.info("🤖 Attempting AI-powered RCA analysis...")
                ...
                logger.info("🔧 Using rule-based analysis (AI not configured or disabled)")
                raise Exception("AI analysis not available, using rule-based fallback")
                
        except Exception as e:
            # Fallback to rule-based analysis
            logger.info("🛠️ Using rule-based analysis as fallback...")
...
# MAGIC
# MAGIC ### ✅ **Completed Features - AI-POWERED VERSION:**
...
# MAGIC - **✅ AI-powered analysis** as primary method with Foundation Model
# MAGIC - **✅ Rule-based fallback** for reliability (100% accuracy from session notes)
# MAGIC
# MAGIC ### 📊 **Expected Performance (AI-Powered with Fallback):**
