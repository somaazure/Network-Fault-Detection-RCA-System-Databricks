...
print("ðŸ› ï¸ Checkpoint cleanup function ready")
...
print("ðŸ“‹ Recreating severity classifications table to fix schema")
...
# ðŸ§¹ Clean checkpoints for fresh start
print("ðŸš€ STARTING FRESH - CLEANING CHECKPOINTS")
