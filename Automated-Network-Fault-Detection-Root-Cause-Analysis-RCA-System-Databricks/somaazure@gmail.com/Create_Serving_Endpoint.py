    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if show_summary:
                ...
                for i, result in enumerate(results.get('predictions', results)):
...
# Sample network logs for batch testing
sample_logs = [
    "[2025-09-07 09:15:32] CRITICAL Fiber-Link-001: Complete fiber cut affecting 50,000 customers in downtown area",
    "[2025-09-07 09:20:45] ERROR Access-Point-234: High packet loss 15% affecting 3,500 wireless customers", 
    "[2025-09-07 09:25:10] WARN Router-Edge-045: CPU utilization 89% - performance degradation possible",
    "[2025-09-07 09:30:22] INFO Switch-Core-012: Scheduled maintenance completed - all systems normal",
    "[2025-09-07 09:35:55] MAJOR Database-Primary: Connection timeout affecting customer portal - 8,000 users impacted"
]

print("ðŸ§ª Testing Batch Log Classification:")
print("=" * 50)
batch_results = classify_batch_logs(sample_logs)
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if isinstance(result, dict) and 'predictions' in result:
                    classification = result['predictions'][0]  # Get first prediction from predictions array
...
batch_results = api_client.classify_batch(batch_logs)
