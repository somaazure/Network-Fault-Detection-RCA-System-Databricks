...
# 2.3 Configure Databricks Authentication for Foundation Model Access
print("ðŸ”§ Configuring Databricks Authentication")
print("=" * 45)

import os

# IMPORTANT: Replace these values with your actual Databricks workspace details
...
print("ðŸ“‹ To enable Foundation Model access:")
print("1. Replace 'https://your-workspace.databricks.com' with your actual workspace URL")
print("2. Go to: Databricks â†’ Settings â†’ Developer â†’ Access Tokens")
print("3. Click 'Generate New Token' â†’ Copy the token")
print("4. Replace 'dapi-your-token-here' with your actual token")
print("5. Re-run this cell after updating the values")
print()

# Verify configuration
workspace_url = os.environ.get('DATABRICKS_HOST', 'Not set')
token_set = 'Yes' if os.environ.get('DATABRICKS_TOKEN', '').startswith('dapi') else 'No (update required)'

print(f"Current Configuration:")
print(f"ðŸ“¡ Workspace URL: {workspace_url}")
print(f"ðŸ”‘ Token Configured: {token_set}")

if workspace_url == 'https://your-workspace.databricks.com' or not token_set.startswith('Yes'):
    print("âš ï¸  CONFIGURATION NEEDED: Update the values above before proceeding")
    print("ðŸ’¡ The agent will fallback to rule-based mode if authentication fails")
else:
    print("âœ… Authentication configured - Foundation Model access should work!")
